...
ResourceGatherer.prototype.Schema =
	...
	"<element name='Rates' a:help='Per-resource-type gather rate multipliers. If a resource type is not specified then it cannot be gathered by this unit'>" +
		"<interleave>" +
			...
			"<optional><element name='water' a:help='Water gather rate'><ref name='positiveDecimal'/></element></optional>" +
			"<optional><element name='treasure' a:help='Treasure gather rate (only presence on value makes sense, size is only used to determine the delay before gathering, so it should be set to 1)'><ref name='positiveDecimal'/></element></optional>" +
			...
			"<optional><element name='water.farm' a:help='Water gather rate (overrides \"water\")'><ref name='positiveDecimal'/></element></optional>" +
			...
			"<optional><element name='treasure.water' a:help='Water treasure gather rate (overrides \"treasure\")'><ref name='positiveDecimal'/></element></optional>" +
		"</interleave>" +
	"</element>" +
	"<element name='Capacities' a:help='Per-resource-type maximum carrying capacity'>" +
		"<interleave>" +
			...
			"<element name='water' a:help='Water capacity'><ref name='positiveDecimal'/></element>" +
		"</interleave>" +
	"</element>";
